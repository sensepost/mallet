...
import com.sensepost.mallet.ognl.OgnlSupport;
...
public class ObjectMapper {
	...
	private ChannelHandler[] getHandlers(OgnlExpression expression) throws OgnlException {
		OgnlContext context = OgnlSupport.INSTANCE.context(null);
	...
	public String toString(Object obj) {
		...
		try {
			OgnlContext context = OgnlSupport.INSTANCE.context(obj);
			return String.valueOf(expression.getValue(context, obj));
		} catch (OgnlException e) {
