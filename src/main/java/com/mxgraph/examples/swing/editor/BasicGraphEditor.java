...
public class BasicGraphEditor extends JPanel {
	 ...
	 * 
	 */
	protected mxIEventListener layoutTracker = new mxIEventListener() {
		public void invoke(Object source, mxEventObject evt) {
			if (!updatingLayout)
	...
	protected void updateGraphLayout() {
		...
		graph.getModel().removeListener(changeTracker, mxEvent.CHANGE);

		// Adds the command history to the model and view
		graph.getModel().removeListener(undoHandler, mxEvent.UNDO);
		graph.getView().removeListener(undoHandler, mxEvent.UNDO);
		...
		// Reinstate the update listeners after updating the layout
	...
	public BasicGraphEditor(String appTitle, mxGraphComponent component) {
		...
		// Updates the layout if the graph model changes
		graph.getModel().addListener(mxEvent.CHANGE, layoutTracker);
